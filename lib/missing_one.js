...
internals.MissingOne = class MissingOne {
...
internals.create_message = function (status_code, body, presence, url, removed_path) {
  return function(help) {
    return {
      ...
      presence: presence,
      testCase: 'missing_one',
      property: removed_path,
      help: help
    }
  }
}
...
module.exports = new internals.MissingOne()
